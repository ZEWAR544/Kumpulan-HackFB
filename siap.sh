...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"MR•ZEWAR"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"Youtube :"$i" Pengangguran Muda"
echo $ku"Facebook :"$i" Moh Iqbal Hidayat"
echo $ku"Instagram :"$i" Iqbalmh18"
sleep 2
